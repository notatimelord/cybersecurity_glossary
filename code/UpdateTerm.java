...
public class UpdateTerm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateTerm</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateTerm at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String original_term = request.getParameter("original_term");
                String term = request.getParameter("term");
                String definition = request.getParameter("definition");
                String source = request.getParameter("source");
                String link = request.getParameter("link");

                String updateQuery = "UPDATE terms SET term = '" + term + "', definition = '" + definition + "', source = '" + source + "', link = '" + link + "' WHERE term = '" + original_term + "'";
